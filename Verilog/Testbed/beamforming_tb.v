...
module beamforming_tb;
	...
	initial begin
		$dumpfile("beamforming_tb.vcd");
		$dumpvars(0, beamforming_tb);
		...
		$display("========================================");
		$display("beamforming_tb summary: errors = %0d", error_count);
		$display("beamforming_tb summary: warnings = %0d", warning_count);
