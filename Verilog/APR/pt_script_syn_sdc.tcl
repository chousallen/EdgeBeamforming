...
update_timing
update_power
report_power > CHIP_power_report_syn_sdc.rpt
report_timing -delay_type max -max_paths 10 -slack_lesser_than 999 -nosplit > CHIP_setup_timing_syn_sdc.rpt
report_timing -delay_type min -max_paths 10 -slack_lesser_than 999 -nosplit > CHIP_hold_timing_syn_sdc.rpt
