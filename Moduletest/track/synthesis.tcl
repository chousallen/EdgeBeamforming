...
write -format verilog -hierarchy -output "$out_dir/track_syn.v"
write_sdf -version 2.1 -context verilog "$out_dir/track.sdf"
write_sdc "$out_dir/track.sdc"
