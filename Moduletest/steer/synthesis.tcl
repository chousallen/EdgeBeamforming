...
write -format verilog -hierarchy -output "$out_dir/steer_syn.v"
write_sdf -version 2.1 -context verilog "$out_dir/steer.sdf"
write_sdc "$out_dir/steer.sdc"
